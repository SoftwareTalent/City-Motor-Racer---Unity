...
void main ()
{
  ...
  tmpvar_32 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_33;
  tmpvar_33 = max (tmpvar_32, (abs (tmpvar_32) * (1.0 - tmpvar_22)));
  lowp float tmpvar_34;
  tmpvar_34 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_34;
  mediump float tmpvar_35;
  tmpvar_35 = max (0.0, nh);
  nh = tmpvar_35;
  mediump float tmpvar_36;
  tmpvar_36 = (pow (tmpvar_35, (tmpvar_12 * 128.0)) * tmpvar_21);
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_26;
  tmpvar_26 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_27;
  tmpvar_27 = max (tmpvar_26, (abs (tmpvar_26) * (1.0 - tmpvar_22)));
  lowp float tmpvar_28;
  tmpvar_28 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_28;
  mediump float tmpvar_29;
  tmpvar_29 = max (0.0, nh);
  nh = tmpvar_29;
  mediump float tmpvar_30;
  tmpvar_30 = (pow (tmpvar_29, (tmpvar_12 * 128.0)) * tmpvar_21);
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_33;
  tmpvar_33 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_34;
  tmpvar_34 = max (tmpvar_33, (abs (tmpvar_33) * (1.0 - tmpvar_22)));
  lowp float tmpvar_35;
  tmpvar_35 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_35;
  mediump float tmpvar_36;
  tmpvar_36 = max (0.0, nh);
  nh = tmpvar_36;
  mediump float tmpvar_37;
  tmpvar_37 = (pow (tmpvar_36, (tmpvar_12 * 128.0)) * tmpvar_21);
...
void main ()
{
  ...
  tmpvar_47 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_48;
  tmpvar_48 = max (tmpvar_47, (abs (tmpvar_47) * (1.0 - tmpvar_22)));
  lowp float tmpvar_49;
  tmpvar_49 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_49;
  mediump float tmpvar_50;
  tmpvar_50 = max (0.0, nh);
  nh = tmpvar_50;
  mediump float tmpvar_51;
  tmpvar_51 = (pow (tmpvar_50, (tmpvar_12 * 128.0)) * tmpvar_21);
...
void main ()
{
  ...
  tmpvar_42 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_43;
  tmpvar_43 = max (tmpvar_42, (abs (tmpvar_42) * (1.0 - tmpvar_22)));
  lowp float tmpvar_44;
  tmpvar_44 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_44;
  mediump float tmpvar_45;
  tmpvar_45 = max (0.0, nh);
  nh = tmpvar_45;
  mediump float tmpvar_46;
  tmpvar_46 = (pow (tmpvar_45, (tmpvar_12 * 128.0)) * tmpvar_21);
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_43;
  tmpvar_43 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_44;
  tmpvar_44 = max (tmpvar_43, (abs (tmpvar_43) * (1.0 - tmpvar_22)));
  lowp float tmpvar_45;
  tmpvar_45 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_45;
  mediump float tmpvar_46;
  tmpvar_46 = max (0.0, nh);
  nh = tmpvar_46;
  mediump float tmpvar_47;
  tmpvar_47 = (pow (tmpvar_46, (tmpvar_12 * 128.0)) * tmpvar_21);
...
Program "fp" {
// Fragment combos: 15
//   opengl - ALU: 62 to 91, TEX: 3 to 9
//   d3d9 - ALU: 65 to 88, TEX: 4 to 10
SubProgram "opengl " {
Keywords { "POINT" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_SpecColor]
...
TEMP R3;
TEX R0.yw, fragment.texcoord[0].zwzw, texture[1], 2D;
MAD R0.xy, R0.wyzw, c[10].w, -c[10].z;
MUL R0.z, R0.y, R0.y;
MAD R0.z, -R0.x, R0.x, -R0;
ADD R0.z, R0, c[10];
RSQ R0.z, R0.z;
...
dp3_pp r0.x, r1, r0
mul_pp r1.w, r1, r4.y
mul_pp r4.x, r0.w, c11.z
max_pp r3.w, r0.x, c10.x
pow_pp r0, r3.w, r4.x
mad_pp r0.y, r4, c5.x, r1.w
dp3_pp r0.w, r1, r3
mul_pp r1.z, r0.x, r0.y
mov_pp r0.xyz, c0
mul_pp r0.xyz, c1, r0
mul_pp r0.xyz, r0, r1.z
abs_pp r1.x, r0.w
add_pp r1.y, -r2.w, c10
mul_pp r1.x, r1, r1.y
max_pp r1.x, r0.w, r1
mad_pp r1.xyz, r2, r1.x, r0
add_pp r0.w, r2, -c9.x
cmp r0.y, r0.w, c10.x, c10
texldp r0.x, v7, s5
rcp r0.z, v7.w
mad r0.z, -v7, r0, r0.x
mov r0.w, c2.x
...
TEMP R3;
TEX R0.yw, fragment.texcoord[0].zwzw, texture[1], 2D;
MAD R0.xy, R0.wyzw, c[11].z, -c[11].y;
MUL R0.z, R0.y, R0.y;
MAD R0.z, -R0.x, R0.x, -R0;
ADD R0.z, R0, c[11].y;
RSQ R0.z, R0.z;
...
dp3_pp r0.x, r1, r0
mul_pp r1.w, r1, r4.y
mul_pp r4.x, r0.w, c13.z
max_pp r3.w, r0.x, c11.x
pow_pp r0, r3.w, r4.x
mad_pp r0.y, r4, c6.x, r1.w
dp3_pp r0.w, r1, r3
mul_pp r1.z, r0.x, r0.y
mov_pp r0.xyz, c1
mul_pp r0.xyz, c2, r0
...
max_pp r1.x, r0.w, r1
mad_pp r1.xyz, r2, r1.x, r0
add_pp r0.w, r2, -c10.x
cmp r1.w, r0, c11.x, c11.y
texld r0, v7, s3
dp4 r0.y, r0, c12
dp3 r2.x, v7, v7
rsq r2.x, r2.x
...
MUL R1.w, R0.x, c[11].x;
ADD R0.x, R1.w, c[10];
MUL_SAT R1.x, R0, R4.z;
MUL R2.w, R1, R4.y;
TEX R0, fragment.texcoord[0], texture[2], 2D;
MUL R0, R0, c[7];
ADD R1.x, -R1, c[14].z;
...
DP3 R0.x, R2, R0;
MAD R1.w, R4.y, c[9].x, R2;
DP3 R2.w, R3, R3;
RSQ R2.w, R2.w;
MUL R3.xyz, R2.w, R3;
DP3 R2.w, R2, R3;
MUL R3.w, R3, c[8].x;
MUL R3.x, R3.w, c[15].y;
MAX R2.w, R2, c[14].x;
POW R2.w, R2.w, R3.x;
MOV R3.xyz, c[1];
MUL R1.w, R2, R1;
...
ABS R0.y, R0.x;
MUL R0.y, R0, R0.z;
RCP R0.z, fragment.texcoord[7].w;
MAX R1.w, R0.x, R0.y;
MAD R0.xy, fragment.texcoord[7], R0.z, c[6];
TEX R0.x, R0, texture[5], 2D;
MAD R1.xyz, R1, R1.w, R3;
MAD R2.xy, fragment.texcoord[7], R0.z, c[5];
MOV R2.w, R0.x;
TEX R0.x, R2, texture[5], 2D;
MAD R2.xy, fragment.texcoord[7], R0.z, c[4];
MOV R2.z, R0.x;
TEX R0.x, R2, texture[5], 2D;
MAD R3.xy, fragment.texcoord[7], R0.z, c[3];
MOV R2.y, R0.x;
TEX R2.x, R3, texture[5], 2D;
MAD R2, -fragment.texcoord[7].z, R0.z, R2;
MOV R0.x, c[14].z;
CMP R2, R2, c[2].x, R0.x;
RCP R0.x, fragment.texcoord[6].w;
MAD R0.xy, fragment.texcoord[6], R0.x, c[14].y;
TEX R1.w, R0, texture[3], 2D;
SLT R0.x, c[14], fragment.texcoord[6].z;
DP4 R2.x, R2, c[14].w;
DP3 R0.z, fragment.texcoord[6], fragment.texcoord[6];
TEX R2.w, R0.z, texture[4], 2D;
MUL R0.x, R0, R1.w;
MUL R0.x, R0, R2.w;
MUL R0.x, R0, R2;
MUL R0.xyz, R0.x, R1;
...
mul_pp r2.w, r0.x, c11.x
add_pp r0.x, r2.w, c10
mul_pp_sat r1.x, r0, r4.z
texld r0, v0, s2
add_pp r3.x, -r1, c14.y
mul_pp r1, r0, c7
...
dp3_pp r0.x, r2, r0
mul_pp r1.xyz, r1, c0
mul_pp r4.x, r0.w, c15.z
max_pp r3.w, r0.x, c14.x
pow_pp r0, r3.w, r4.x
mul_pp r0.y, r2.w, r4
dp3_pp r0.w, r2, r3
rcp r3.z, v7.w
mad_pp r0.y, r4, c9.x, r0
...
pow_pp r1, r0.w, c12.x
mov_pp r0.w, r1.x
mul_pp r0.w, r0, c11.x
add_pp r1.x, r0.w, c10
mul_pp_sat r2.x, r1, r4.z
texld r1, v0, s2
mul_pp r1, r1, c7
...
rsq_pp r2.w, r2.w
mad_pp r3.xyz, r2.w, v5, r1
dp3_pp r2.w, r3, r3
rsq_pp r2.w, r2.w
mul_pp r3.xyz, r2.w, r3
dp3_pp r2.w, r0, r3
mul_pp r2.xyz, r2, c0
max_pp r2.w, r2, c14.x
mul_pp r4.x, r3.w, c15.z
pow_pp r3, r2.w, r4.x
mov_pp r2.w, r3.x
mad_pp r0.w, r4.y, c9.x, r0
mul_pp r2.w, r2, r0
dp3_pp r0.w, r0, r1
mov_pp r3.xyz, c0
mul_pp r0.xyz, c1, r3
...
DP3 R1.w, fragment.texcoord[5], fragment.texcoord[5];
RSQ R0.w, R1.w;
MAD R2.xyz, R0.w, fragment.texcoord[5], R3;
MAD R0.w, R4.y, c[6].x, R3;
DP3 R1.w, R2, R2;
RSQ R1.w, R1.w;
MUL R2.xyz, R1.w, R2;
DP3 R1.w, R0, R2;
...
mul_pp r0.xyz, r0.w, r0
mul_pp r3.x, r3, r3.z
mul_pp r0.w, r3.x, c5.x
dp3_pp r0.x, r1, r0
dp3_pp r3.w, r1, r4
mul_pp r3.z, r0.w, c14.x
max_pp r3.x, r0, c11
pow_pp r0, r3.x, r3.z
mul_pp r0.y, r1.w, r3
mad_pp r0.y, r3, c6.x, r0
...
RSQ R0.z, R0.z;
MUL R4.xyz, R0.z, fragment.texcoord[4];
DP3 R0.w, fragment.texcoord[5], fragment.texcoord[5];
RSQ R0.z, R0.w;
MAD R3.xyz, R0.z, fragment.texcoord[5], R4;
MAD R0.w, R0.y, c[6].x, R1;
DP3 R0.y, R3, R3;
MUL R0.z, R0.x, R0.x;
MUL R1.w, R0.x, R0.z;
RSQ R0.y, R0.y;
