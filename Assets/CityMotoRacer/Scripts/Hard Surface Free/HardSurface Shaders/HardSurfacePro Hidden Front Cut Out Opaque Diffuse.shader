...
void main ()
{
  ...
  lowp vec3 tmpvar_19;
  tmpvar_19 = mix (CubeTex, (CubeTex * tmpvar_14.xyz), vec3(((1.0 - (tmpvar_17 * tmpvar_17)) * _Metalics)));
  lowp float tmpvar_20;
  tmpvar_20 = tmpvar_14.w;
  lowp vec3 tmpvar_21;
  tmpvar_21 = (tmpvar_14.xyz * (1.0 - clamp (tmpvar_16, 0.0, 1.0)));
  float x_i0_i1;
  x_i0_i1 = (tmpvar_20 - _Cutoff);
  if ((x_i0_i1 < 0.0)) {
    disBIKEd;
  };
...
void main ()
{
  ...
  tmpvar_17 = clamp (dot (CubeTex, vec3(0.22, 0.707, 0.071)), 0.0, 1.0);
  lowp vec3 tmpvar_18;
  tmpvar_18 = mix (CubeTex, (CubeTex * tmpvar_14.xyz), vec3(((1.0 - (tmpvar_17 * tmpvar_17)) * _Metalics)));
  lowp float tmpvar_19;
  tmpvar_19 = tmpvar_14.w;
  lowp vec3 tmpvar_20;
  tmpvar_20 = (tmpvar_14.xyz * (1.0 - clamp (tmpvar_16, 0.0, 1.0)));
  float x_i0_i1;
  ...
  c.xyz = (tmpvar_20 * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz));
  c.w = tmpvar_19;
  c.xyz = (c.xyz + tmpvar_18);
  c.w = tmpvar_19;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = (tmpvar_20 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7).x * 2.0))));
  c.w = tmpvar_19;
  c.xyz = (c.xyz + tmpvar_18);
  c.w = tmpvar_19;
  gl_FragData[0] = c;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 37 to 61, TEX: 2 to 4
//   d3d9 - ALU: 40 to 67, TEX: 4 to 6
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
...
POW R1.w, R0.w, c[7].x;
MOV R1.x, c[5];
MAD R2.x, R1.w, c[6], R1;
MUL R1.xyz, R2.x, R0;
DP3_SAT R0.x, R1, c[11];
MAD R0.x, -R0, R0, c[10].y;
MUL R2.w, R0.x, c[8].x;
MOV_SAT R2.x, R2;
...
MUL R2.xyz, R0, fragment.texcoord[6];
MUL R1.xyz, R0, c[0];
RSQ R2.w, R2.w;
...
DP3 R0.y, R0, R0;
MOV R2.w, c[4].x;
MAD R0.x, R1.w, c[6], R2.w;
RSQ R1.w, R0.y;
MUL R0.z, R1.w, R0;
MOV R0.y, c[10].w;
MUL R1.w, R0.y, c[3].x;
MAX R0.y, R0.z, c[10].z;
POW R0.y, R0.y, R1.w;
MUL R2.w, R0.y, R0.x;
MOV R0.xyz, c[1];
MUL R0.xyz, R0, c[0];
ADD R3.w, -R0, c[10].y;
ABS R1.w, fragment.texcoord[5].z;
MUL R1.w, R1, R3;
MUL R0.xyz, R0, R2.w;
MAX R1.w, fragment.texcoord[5].z, R1;
...
dcl_2d s0
dcl_cube s1
def c10, 0.00000000, 1.00000000, 2.00000000, 128.00000000
...
mov_pp r2.w, r0.x
mov_pp r0.y, c5.x
mad_pp r0.w, r2, c6.x, r0.y
texldl r1.xyz, r1, s1
mul_pp r0.xyz, r0.w, r1
dp3_pp_sat r2.x, r0, c11.yzww
mad_pp r2.x, -r2, r2, c10.y
texld r1, v0, s0
mul_pp r1, r1, c2
mul_pp r3.x, r2, c8
...
mul_pp r4.x, c10.w, r0.y
pow_pp r0, r3.w, r4.x
mov_pp r0.y, c4.x
mad_pp r0.y, r2.w, c6.x, r0
mul_pp r2.w, r0.x, r0.y
mov_pp r0.xyz, c0
mul_pp r0.xyz, c1, r0
add_pp r3.w, -r1, c10.y
abs_pp r0.w, v5.z
mul_pp r0.w, r0, r3
max_pp r0.w, v5.z, r0
...
dcl_cube s1
dcl_2d s2
def c7, 0.00000000, 1.00000000, 2.00000000, 6.00000000
...
pow_pp r0, r2.x, c4.x
mov_pp r0.y, c2.x
mad_pp r2.x, r0, c3, r0.y
texldl r1.xyz, r1, s1
mul_pp r0.xyz, r2.x, r1
dp3_pp_sat r0.w, r0, c8
mov_pp_sat r2.w, r2.x
mad_pp r0.w, -r0, r0, c7.y
texld r1, v0, s0
mul_pp r1, r1, c0
mad_pp r2.xyz, r1, r0, -r0
mul_pp r0.w, r0, c5.x
...
RSQ R2.y, R2.x;
MOV R2.w, c[4].x;
MAD R1.w, R1, c[6].x, R2;
MUL R2.y, R2, R2.z;
MOV R2.x, c[10].w;
MUL R2.z, R2.x, c[3].x;
MAX R2.x, R2.y, c[10].z;
POW R2.x, R2.x, R2.z;
MUL R2.w, R2.x, R1;
MOV R2.xyz, c[1];
MUL R2.xyz, R2, c[0];
...
dcl_2d s2
dcl_2d s3
def c7, 0.00000000, 1.00000000, 2.00000000, 8.00000000
...
void main ()
{
  ...
  frez = tmpvar_15;
  lowp float tmpvar_16;
  tmpvar_16 = (_Gloss + tmpvar_15);
  lowp float tmpvar_17;
  tmpvar_17 = tmpvar_14.w;
  lowp vec3 tmpvar_18;
  tmpvar_18 = (tmpvar_14.xyz * (1.0 - clamp ((_Reflection + tmpvar_15), 0.0, 1.0)));
  float x_i0_i1;
  x_i0_i1 = (tmpvar_17 - _Cutoff);
  if ((x_i0_i1 < 0.0)) {
    disBIKEd;
  };
  ...
  lowp float tmpvar_23;
  tmpvar_23 = max (tmpvar_22, (abs (tmpvar_22) * (1.0 - tmpvar_17)));
  lowp float tmpvar_24;
  ...
  nh = tmpvar_25;
  mediump float tmpvar_26;
  tmpvar_26 = (pow (tmpvar_25, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_27;
  tmpvar_27 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_23) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_26)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_27;
  mediump float tmpvar_28;
  tmpvar_28 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_26) * atten));
  c_i0_i1.w = tmpvar_28;
  c = c_i0_i1;
  c.w = tmpvar_17;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_20;
  tmpvar_20 = dot (vec3(0.0, 0.0, 1.0), lightDir);
  lowp float tmpvar_21;
  tmpvar_21 = max (tmpvar_20, (abs (tmpvar_20) * (1.0 - tmpvar_17)));
  lowp float tmpvar_22;
  tmpvar_22 = dot (vec3(0.0, 0.0, 1.0), normalize ((lightDir + viewDir)));
  nh = tmpvar_22;
  mediump float tmpvar_23;
  tmpvar_23 = max (0.0, nh);
  nh = tmpvar_23;
  mediump float tmpvar_24;
  tmpvar_24 = (pow (tmpvar_23, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_25;
  tmpvar_25 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_21) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_24)) * 2.0);
  c_i0_i1.xyz = tmpvar_25;
  mediump float tmpvar_26;
  tmpvar_26 = (tmpvar_17 + ((_LightColor0.w * _SpecColor.w) * tmpvar_24));
  c_i0_i1.w = tmpvar_26;
  c = c_i0_i1;
  c.w = tmpvar_17;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_24 = (pow (tmpvar_23, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_25;
  tmpvar_25 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_21) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_24)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_25;
  mediump float tmpvar_26;
  tmpvar_26 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_24) * atten));
  c_i0_i1.w = tmpvar_26;
  c = c_i0_i1;
  c.w = tmpvar_17;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_20 = normalize (xlv_TEXCOORD5);
  lowp float tmpvar_21;
  tmpvar_21 = texture2D (_LightTexture0, ((xlv_TEXCOORD6.xy / xlv_TEXCOORD6.w) + 0.5)).w;
  lowp float tmpvar_22;
  highp vec3 LightCoord_i0;
  LightCoord_i0 = xlv_TEXCOORD6.xyz;
  ...
  highp float tmpvar_26;
  if ((tmpvar_25.x < (xlv_TEXCOORD7.z / xlv_TEXCOORD7.w))) {
  ...
  viewDir = tmpvar_20;
  lowp float atten;
  atten = (((float((xlv_TEXCOORD6.z > 0.0)) * tmpvar_21) * tmpvar_22) * tmpvar_24);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_27;
  tmpvar_27 = dot (vec3(0.0, 0.0, 1.0), lightDir);
  lowp float tmpvar_28;
  tmpvar_28 = max (tmpvar_27, (abs (tmpvar_27) * (1.0 - tmpvar_17)));
  lowp float tmpvar_29;
  tmpvar_29 = dot (vec3(0.0, 0.0, 1.0), normalize ((lightDir + viewDir)));
  nh = tmpvar_29;
  mediump float tmpvar_30;
  tmpvar_30 = max (0.0, nh);
  nh = tmpvar_30;
  mediump float tmpvar_31;
  tmpvar_31 = (pow (tmpvar_30, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_32;
  tmpvar_32 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_28) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_31)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_32;
  mediump float tmpvar_33;
  tmpvar_33 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_31) * atten));
  c_i0_i1.w = tmpvar_33;
  c = c_i0_i1;
  c.w = tmpvar_17;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lowp float tmpvar_22;
  tmpvar_22 = max (tmpvar_21, (abs (tmpvar_21) * (1.0 - tmpvar_17)));
  lowp float tmpvar_23;
  ...
  nh = tmpvar_24;
  mediump float tmpvar_25;
  tmpvar_25 = (pow (tmpvar_24, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_26;
  tmpvar_26 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_22) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_25)) * (tmpvar_20 * 2.0));
  c_i0_i1.xyz = tmpvar_26;
  mediump float tmpvar_27;
  tmpvar_27 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_25) * tmpvar_20));
  c_i0_i1.w = tmpvar_27;
  c = c_i0_i1;
  c.w = tmpvar_17;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_23 = ((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97);
  highp vec4 packDist;
  lowp vec4 tmpvar_24;
  tmpvar_24 = textureCube (_ShadowMapTexture, xlv_TEXCOORD7);
  packDist = tmpvar_24;
  highp float tmpvar_25;
  tmpvar_25 = dot (packDist, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp float tmpvar_26;
...
void main ()
{
  ...
  highp float tmpvar_24;
  tmpvar_24 = ((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97);
  highp vec4 packDist;
  lowp vec4 tmpvar_25;
  ...
  viewDir = tmpvar_20;
  lowp float atten;
  atten = ((tmpvar_22.w * tmpvar_23.w) * tmpvar_27);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_28;
  tmpvar_28 = dot (vec3(0.0, 0.0, 1.0), lightDir);
  lowp float tmpvar_29;
  tmpvar_29 = max (tmpvar_28, (abs (tmpvar_28) * (1.0 - tmpvar_17)));
  ...
  nh = tmpvar_31;
  mediump float tmpvar_32;
  tmpvar_32 = (pow (tmpvar_31, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_33;
  tmpvar_33 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_29) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_32)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_33;
  mediump float tmpvar_34;
  tmpvar_34 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_32) * atten));
  c_i0_i1.w = tmpvar_34;
  c = c_i0_i1;
  c.w = tmpvar_17;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lowp float tmpvar_27;
  tmpvar_27 = texture2D (_ShadowMapTexture, (tmpvar_26 + _ShadowOffsets[0].xy)).x;
  shadowVals.x = tmpvar_27;
  highp vec2 tmpvar_28;
  tmpvar_28 = tmpvar_25.xy;
  lowp float tmpvar_29;
  tmpvar_29 = texture2D (_ShadowMapTexture, (tmpvar_28 + _ShadowOffsets[1].xy)).x;
  shadowVals.y = tmpvar_29;
  highp vec2 tmpvar_30;
  tmpvar_30 = tmpvar_25.xy;
  lowp float tmpvar_31;
  tmpvar_31 = texture2D (_ShadowMapTexture, (tmpvar_30 + _ShadowOffsets[2].xy)).x;
  shadowVals.z = tmpvar_31;
  highp vec2 tmpvar_32;
  tmpvar_32 = tmpvar_25.xy;
  lowp float tmpvar_33;
  tmpvar_33 = texture2D (_ShadowMapTexture, (tmpvar_32 + _ShadowOffsets[3].xy)).x;
  shadowVals.w = tmpvar_33;
  bvec4 tmpvar_34;
  tmpvar_34 = lessThan (shadowVals, tmpvar_25.zzzz);
  highp vec4 tmpvar_35;
  ...
  tmpvar_42 = dot (vec3(0.0, 0.0, 1.0), lightDir);
  lowp float tmpvar_43;
  tmpvar_43 = max (tmpvar_42, (abs (tmpvar_42) * (1.0 - tmpvar_17)));
  lowp float tmpvar_44;
  tmpvar_44 = dot (vec3(0.0, 0.0, 1.0), normalize ((lightDir + viewDir)));
  nh = tmpvar_44;
  mediump float tmpvar_45;
  tmpvar_45 = max (0.0, nh);
  nh = tmpvar_45;
  mediump float tmpvar_46;
  tmpvar_46 = (pow (tmpvar_45, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_47;
  tmpvar_47 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_43) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_46)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_47;
  mediump float tmpvar_48;
  tmpvar_48 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_46) * atten));
...
void main ()
{
  ...
  highp vec4 packDist;
  lowp vec4 tmpvar_24;
  tmpvar_24 = textureCube (_ShadowMapTexture, vec_i0);
  packDist = tmpvar_24;
  ...
  lowp vec4 tmpvar_25;
  tmpvar_25 = textureCube (_ShadowMapTexture, vec_i0_i1);
  packDist_i0 = tmpvar_25;
  ...
  lowp vec4 tmpvar_26;
  tmpvar_26 = textureCube (_ShadowMapTexture, vec_i0_i1_i2);
  packDist_i0_i1 = tmpvar_26;
  ...
  lowp vec4 tmpvar_27;
  tmpvar_27 = textureCube (_ShadowMapTexture, vec_i0_i1_i2_i3);
  packDist_i0_i1_i2 = tmpvar_27;
  shadowVals.w = dot (packDist_i0_i1_i2, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec4 tmpvar_28;
  tmpvar_28 = vec4(((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97));
  bvec4 tmpvar_29;
  tmpvar_29 = lessThan (shadowVals, tmpvar_28);
  ...
  viewDir = tmpvar_20;
  lowp float atten;
  atten = (tmpvar_22.w * tmpvar_23);
  lowp vec4 c_i0_i1_i2;
  mediump float nh;
  lowp float tmpvar_37;
  tmpvar_37 = dot (vec3(0.0, 0.0, 1.0), lightDir);
  lowp float tmpvar_38;
  tmpvar_38 = max (tmpvar_37, (abs (tmpvar_37) * (1.0 - tmpvar_17)));
  lowp float tmpvar_39;
  tmpvar_39 = dot (vec3(0.0, 0.0, 1.0), normalize ((lightDir + viewDir)));
  nh = tmpvar_39;
  mediump float tmpvar_40;
  tmpvar_40 = max (0.0, nh);
  nh = tmpvar_40;
  mediump float tmpvar_41;
  tmpvar_41 = (pow (tmpvar_40, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_42;
  tmpvar_42 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_38) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_41)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_42;
  mediump float tmpvar_43;
  tmpvar_43 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_41) * atten));
  c_i0_i1_i2.w = tmpvar_43;
  c = c_i0_i1_i2;
  c.w = tmpvar_17;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_29 = vec4(((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97));
  bvec4 tmpvar_30;
  ...
  viewDir = tmpvar_20;
  lowp float atten;
  atten = ((tmpvar_22.w * tmpvar_23.w) * tmpvar_24);
  lowp vec4 c_i0_i1_i2;
  mediump float nh;
  lowp float tmpvar_38;
  tmpvar_38 = dot (vec3(0.0, 0.0, 1.0), lightDir);
  lowp float tmpvar_39;
  tmpvar_39 = max (tmpvar_38, (abs (tmpvar_38) * (1.0 - tmpvar_17)));
  ...
  tmpvar_42 = (pow (tmpvar_41, (_Shininess * 128.0)) * tmpvar_16);
  mediump vec3 tmpvar_43;
  tmpvar_43 = ((((tmpvar_18 * _LightColor0.xyz) * tmpvar_39) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_42)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_43;
  mediump float tmpvar_44;
  tmpvar_44 = (tmpvar_17 + (((_LightColor0.w * _SpecColor.w) * tmpvar_42) * atten));
...
Program "fp" {
// Fragment combos: 15
//   opengl - ALU: 49 to 77, TEX: 1 to 7
//   d3d9 - ALU: 55 to 77, TEX: 2 to 8
SubProgram "opengl " {
Keywords { "POINT" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_SpecColor]
...
RSQ R2.x, R2.x;
MAD R2.xyz, R2.x, fragment.texcoord[5], R1;
MOV R1.x, c[4];
DP3 R1.y, R2, R2;
MAD R1.x, R1.w, c[6], R1;
RSQ R1.w, R1.y;
MOV R1.y, c[9].w;
MUL R1.w, R1, R2.z;
MUL R2.x, R1.y, c[3];
...
dcl_2d s0
dcl_2d s1
def c9, 0.00000000, 1.00000000, 2.00000000, 128.00000000
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyzw
dcl_texcoord2 v2.xyzw
dcl_texcoord3 v3.xyzw
...
rsq_pp r2.x, r2.x
mad_pp r2.xyz, r2.x, v5, r1
dp3_pp r1.x, r2, r2
rsq_pp r1.x, r1.x
mul_pp r1.y, r1.x, r2.z
mov_pp r2.x, c3
mov_pp r1.w, r0.x
mov_pp r0.y, c5.x
mad_pp_sat r0.x, r1.w, c6, r0.y
add_pp r2.w, -r0.x, c9.y
texld r0, v0, s0
mul_pp r0, r0, c2
mul_pp r0.xyz, r0, r2.w
mul_pp r0.xyz, r0, c0
...
MAD R1.xyz, R2.x, fragment.texcoord[5], R1;
DP3 R1.y, R1, R1;
MOV R2.x, c[4];
MAD R1.x, R1.w, c[6], R2;
RSQ R1.w, R1.y;
MUL R1.z, R1.w, R1;
MOV R1.y, c[9].w;
MUL R1.w, R1.y, c[3].x;
...
mov_pp r2.x, r0
mov_pp r0.y, c5.x
mad_pp_sat r0.x, r2, c6, r0.y
add_pp r0.w, -r0.x, c9.y
mul_pp r1.xyz, r1, r0.w
rsq_pp r2.y, r2.y
mov_pp r0.xyz, v4
...
mul_pp r2.z, c9.w, r0.y
pow_pp r0, r2.y, r2.z
mov_pp r0.y, c4.x
mad_pp r2.x, r2, c6, r0.y
mov_pp r0.w, r0.x
mul_pp r0.w, r0, r2.x
mov_pp r0.xyz, c0
mul_pp r0.xyz, c1, r0
...
POW R0.w, R0.x, c[7].x;
MOV R0.y, c[5].x;
MAD_SAT R0.x, R0.w, c[6], R0.y;
ADD R0.x, -R0, c[9].w;
MUL R0.xyz, R2, R0.x;
RSQ R1.w, R1.w;
MAD R2.xyz, R1.w, fragment.texcoord[5], R1;
MOV R1.y, c[4].x;
...
mad_pp r1.xyz, r0, r1.x, r2
add_pp r0.y, r0.w, -c8.x
cmp r0.z, r0.y, c9.x, c9.y
rcp r0.x, v6.w
mad r0.xy, v6, r0.x, c9.z
texld r1.w, r0, s1
dp3 r2.x, v6, v6
texld r0.x, r2.x, s2
...
TEX R0.w, fragment.texcoord[6], texture[2], CUBE;
TEX R1.w, R1.x, texture[1], 2D;
MUL R0.w, R1, R0;
MUL R0.xyz, R0.w, R0;
MUL result.color.xyz, R0, c[9].x;
...
add_pp r2.w, -r0.x, c9.y
texld r0, v0, s0
mul_pp r0, r0.yzwx, c2.yzwx
mul_pp r0.xyw, r0.wxzy, r2.w
mul_pp r0.xyw, r0, c0.xyzz
mul_pp r1.x, c9.w, r2
max_pp r1.y, r1, c9.x
pow_pp r2, r1.y, r1.x
mov_pp r1.x, c4
...
mul_pp r1.x, r1, r1.y
max_pp r1.x, r1.z, r1
mad_pp r1.xyz, r0.xyww, r1.x, r2
add_pp r1.w, r0.z, -c8.x
dp3 r0.x, v6, v6
cmp r0.y, r1.w, c9.x, c9
texld r0.w, v6, s2
texld r0.x, r0.x, s1
mul r0.x, r0, r0.w
mul_pp r2.xyz, r0.x, r1
mov_pp r1, -r0.y
mul_pp oC0.xyz, r2, c9.z
texkill r1.xyzw
mov_pp oC0.w, r0.z
"
}
...
mul_pp r0.xyz, r0, r0.w
abs_pp r0.w, v4.z
add_pp r2.x, -r1.w, c9.y
mul_pp r2.x, r0.w, r2
max_pp r2.x, v4.z, r2
mad_pp r0.xyz, r1, r2.x, r0
add_pp r0.w, r1, -c8.x
cmp r2.x, r0.w, c9, c9.y
texld r0.w, v6, s1
...
mov_pp r0.w, r0.x
mov_pp r0.y, c6.x
mad_pp_sat r0.x, r0.w, c7, r0.y
add_pp r2.w, -r0.x, c10.y
mul_pp r1.xyz, r1, r2.w
dp3_pp r0.x, v4, v4
rsq_pp r0.x, r0.x
mul_pp r0.xyz, r0.x, v4
rsq_pp r2.x, r2.x
mad_pp r2.xyz, r2.x, v5, r0
dp3_pp r0.x, r2, r2
rsq_pp r0.y, r0.x
mul_pp r0.y, r0, r2.z
mov_pp r0.x, c4
...
add_pp r0.x, r1.w, -c9
cmp r0.y, r0.x, c10.x, c10
rcp r0.w, v6.w
mad r2.xy, v6, r0.w, c10.z
texld r0.w, r2, s1
cmp r2.x, -v6.z, c10, c10.y
texldp r0.x, v7, s3
rcp r0.z, v7.w
mad r0.z, -v7, r0, r0.x
mov r0.x, c2
cmp r0.z, r0, c10.y, r0.x
dp3 r0.x, v6, v6
mul_pp r0.w, r2.x, r0
texld r0.x, r0.x, s2
mul_pp r0.x, r0.w, r0
...
RSQ R2.x, R1.x;
TEX R1, fragment.texcoord[7], texture[1], CUBE;
DP4 R1.y, R1, c[12];
RCP R2.x, R2.x;
MUL R1.x, R2, c[0].w;
MAD R1.z, -R1.x, c[11].x, R1.y;
MOV R1.x, c[11].y;
DP3 R1.y, fragment.texcoord[6], fragment.texcoord[6];
CMP R1.x, R1.z, c[3], R1;
TEX R1.w, R1.y, texture[2], 2D;
MUL R1.x, R1.w, R1;
MUL R0.xyz, R1.x, R0;
MUL result.color.xyz, R0, c[11].z;
SLT R0.x, R0.w, c[10];
MOV result.color.w, R0;
KIL -R0.x;
END
...
dcl_cube s1
dcl_2d s2
def c11, 0.00000000, 1.00000000, 0.97000003, 2.00000000
...
dp3 r0.w, r0, r1
mul r2.xyz, r0, r0.w
mad r1.xyz, -r2, c11.w, r1
dp3 r0.w, r1, r1
rsq r0.w, r0.w
mul r1.xyz, r0.w, r1
dp3_pp r0.x, r1, r0
abs_pp r0.x, r0
add_pp r1.x, -r0, c11.y
pow_pp r0, r1.x, c9.x
dp3_pp r1.x, v4, v4
rsq_pp r1.x, r1.x
dp3_pp r2.x, v5, v5
...
mov_pp r1.w, r0.x
mov_pp r0.y, c7.x
mad_pp_sat r0.x, r1.w, c8, r0.y
add_pp r2.w, -r0.x, c11.y
texld r0, v0, s0
mul_pp r0, r0, c4
mul_pp r0.xyz, r0, r2.w
mul_pp r0.xyz, r0, c1
mul_pp r1.x, c13, r2
max_pp r1.y, r1, c11.x
pow_pp r2, r1.y, r1.x
mov_pp r1.x, c6
mad_pp r1.y, r1.w, c8.x, r1.x
mov_pp r1.x, r2
mul_pp r1.y, r1.x, r1
mov_pp r2.xyz, c1
mul_pp r2.xyz, c2, r2
mul_pp r2.xyz, r2, r1.y
add_pp r1.w, -r0, c11.y
abs_pp r1.x, r1.z
mul_pp r1.x, r1, r1.w
max_pp r1.x, r1.z, r1
mad_pp r1.xyz, r0, r1.x, r2
...
dp3 r0.y, v7, v7
cmp r1.w, r0.x, c11.x, c11.y
rsq r0.x, r0.y
texld r2, v7, s1
rcp r0.x, r0.x
mul r0.x, r0, c0.w
dp4 r0.y, r2, c12
mad r0.y, -r0.x, c11.z, r0
mov r0.z, c3.x
dp3 r0.x, v6, v6
...
POW R0.w, R0.x, c[9].x;
MOV R0.y, c[7].x;
MAD_SAT R0.x, R0.w, c[8], R0.y;
ADD R0.x, -R0, c[11].y;
MUL R0.xyz, R2, R0.x;
RSQ R1.w, R1.w;
MAD R2.xyz, R1.w, fragment.texcoord[5], R1;
MOV R1.y, c[6].x;
MAD R0.w, R0, c[8].x, R1.y;
DP3 R1.x, R2, R2;
RSQ R1.y, R1.x;
MUL R1.y, R1, R2.z;
MOV R1.x, c[13];
MUL R1.w, R1.x, c[5].x;
MAX R1.x, R1.y, c[11].w;
POW R1.x, R1.x, R1.w;
MUL R1.x, R1, R0.w;
MOV R2.xyz, c[2];
MUL R2.xyz, R2, c[1];
...
mul_pp r1.xyz, r1, c1
mul_pp r0.x, c13, r0
max_pp r0.y, r0, c11.x
pow_pp r2, r0.y, r0.x
mov_pp r0.y, r2.x
mov_pp r0.x, c6
mad_pp r0.x, r0.w, c8, r0
mul_pp r0.x, r0.y, r0
mov_pp r2.xyz, c1
mul_pp r2.xyz, c2, r2
mul_pp r2.xyz, r2, r0.x
abs_pp r0.y, r0.z
add_pp r0.x, -r1.w, c11.y
mul_pp r0.x, r0.y, r0
max_pp r0.x, r0.z, r0
mad_pp r0.xyz, r1, r0.x, r2
add_pp r0.w, r1, -c10.x
cmp r1.y, r0.w, c11.x, c11
texld r2, v7, s1
dp4 r1.x, r2, c12
dp3 r0.w, v7, v7
rsq r0.w, r0.w
...
mul r1.z, r1, c0.w
mov_pp r2, -r1.y
mad r1.x, -r1.z, c11.z, r1
mov r0.w, c3.x
cmp r1.z, r1.x, c11.y, r0.w
dp3 r1.x, v6, v6
texld r0.w, v6, s3
texld r1.x, r1.x, s2
mul r0.w, r1.x, r0
...
Float 8 [_Shininess]
Float 9 [_Gloss]
Float 10 [_Reflection]
Float 11 [_FrezPow]
Float 12 [_FrezFalloff]
Float 13 [_Cutoff]
SetTexture 0 [_MainTex] 2D
SetTexture 1 [_LightTexture0] 2D
SetTexture 2 [_LightTextureB0] 2D
...
ABS R0.x, R0;
ADD R0.x, -R0, c[14].z;
POW R0.w, R0.x, c[12].x;
MOV R0.y, c[10].x;
MAD_SAT R0.x, R0.w, c[11], R0.y;
ADD R0.x, -R0, c[14].z;
MUL R0.xyz, R2, R0.x;
MUL R1.xyz, R0, c[0];
...
RSQ R1.w, R1.w;
MAD R2.xyz, R1.w, fragment.texcoord[5], R0;
MOV R0.x, c[9];
DP3 R0.y, R2, R2;
MAD R0.x, R0.w, c[11], R0;
RSQ R0.w, R0.y;
MUL R0.w, R0, R2.z;
MOV R0.y, c[15];
MUL R1.w, R0.y, c[8].x;
MAX R0.y, R0.w, c[14].x;
POW R0.y, R0.y, R1.w;
MUL R0.x, R0.y, R0;
MOV R2.xyz, c[1];
MUL R2.xyz, R2, c[0];
...
def c15, 2.00000000, 128.00000000, 0, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyzw
dcl_texcoord2 v2.xyzw
dcl_texcoord3 v3.xyzw
...
dp3_pp r0.x, r1, r0
abs_pp r0.x, r0
add_pp r1.x, -r0, c14.y
pow_pp r0, r1.x, c12.x
texld r1, v0, s0
mul_pp r2, r1, c7
mov_pp r3.z, r0.x
mov_pp r0.y, c10.x
mad_pp_sat r0.x, r3.z, c11, r0.y
add_pp r0.w, -r0.x, c14.y
mul_pp r1.xyz, r2, r0.w
dp3_pp r0.x, v4, v4
rsq_pp r0.x, r0.x
mul_pp r3.xyw, r0.x, v4.xyzz
dp3_pp r0.y, v5, v5
rsq_pp r0.x, r0.y
mad_pp r0.xyz, r0.x, v5, r3.xyww
dp3_pp r0.x, r0, r0
rsq_pp r0.x, r0.x
mul_pp r2.xyz, r1, c0
mov_pp r0.y, c8.x
...
mad r0.xy, v7, r0.z, c6
mad r1.xy, v7, r0.z, c5
texld r0.x, r0, s3
mov r1.w, r0.x
texld r1.x, r1, s3
mov r1.z, r1.x
mad r1.xy, v7, r0.z, c3
mad r0.xy, v7, r0.z, c4
texld r1.x, r1, s3
texld r0.x, r0, s3
mov r1.y, r0.x
mad r0, -v7.z, r0.z, r1
...
dp4_pp r1.w, r0, c14.w
add_pp r1.z, -r2.w, c14.y
abs_pp r1.x, r3.w
mul_pp r1.x, r1, r1.z
max_pp r1.x, r3.w, r1
...
cmp r0.x, r0.y, c14, c14.y
mov_pp r0, -r0.x
mul_pp oC0.xyz, r1, c15.x
texkill r0.xyzw
mov_pp oC0.w, r2
"
}
...
mov_pp r2.w, r0.x
mov_pp r0.y, c10.x
mad_pp_sat r0.x, r2.w, c11, r0.y
add_pp r0.w, -r0.x, c14.y
mul_pp r1.xyz, r1, r0.w
dp3_pp r0.x, v4, v4
rsq_pp r0.x, r0.x
mul_pp r2.xyz, r1, c0
mul_pp r4.xyz, r0.x, v4
dp3_pp r0.y, v5, v5
rsq_pp r0.x, r0.y
mad_pp r0.xyz, r0.x, v5, r4
dp3_pp r0.x, r0, r0
mov_pp r0.y, c8.x
rsq_pp r0.x, r0.x
mul_pp r0.x, r0, r0.z
...
pow_pp r0, r1.x, r1.y
mov_pp r0.y, c9.x
mad_pp r1.x, r2.w, c11, r0.y
mov_pp r0.w, r0.x
mul_pp r0.w, r0, r1.x
mad r1.xyz, v7, r3.w, c4
mov_pp r0.xyz, c0
mul_pp r0.xyz, c1, r0
mul_pp r3.xyz, r0, r0.w
mad r0.xyz, v7, r3.w, c6
texld r0.x, r0, s3
add_pp r0.w, -r1, c14.y
abs_pp r0.y, r4.z
mul_pp r2.w, r0.y, r0
mov_pp r0.w, r0.x
mad r0.xyz, v7, r3.w, c5
texld r0.x, r0, s3
texld r1.x, r1, s3
mov_pp r0.z, r0.x
mov_pp r0.y, r1.x
mad r1.xyz, v7, r3.w, c3
mov r0.x, c2
add r3.w, c14.y, -r0.x
texld r0.x, r1, s3
max_pp r1.x, r4.z, r2.w
mad r0, r0, r3.w, c2.x
mad_pp r1.xyz, r2, r1.x, r3
dp4_pp r2.z, r0, c14.w
rcp r0.x, v6.w
mad r2.xy, v6, r0.x, c14.z
dp3 r0.x, v6, v6
...
RSQ R0.x, R0.y;
MAD R0.xyz, R0.x, fragment.texcoord[5], R3;
DP3 R0.x, R0, R0;
RSQ R0.y, R0.x;
MUL R0.y, R0, R0.z;
MOV R0.x, c[13].w;
MUL R0.z, R0.x, c[5].x;
MAD R0.w, R0, c[8].x, R1;
MAX R0.x, R0.y, c[13].z;
POW R1.w, R0.x, R0.z;
MUL R0.w, R1, R0;
MOV R0.xyz, c[2];
MUL R0.xyz, R0, c[1];
...
ADD R0.xyz, fragment.texcoord[7], c[11].yzzw;
TEX R0, R0, texture[1], CUBE;
DP4 R3.w, R0, c[12];
ADD R0.xyz, fragment.texcoord[7], c[11].zyzw;
TEX R0, R0, texture[1], CUBE;
DP4 R3.z, R0, c[12];
ADD R1.xyz, fragment.texcoord[7], c[11].zzyw;
TEX R1, R1, texture[1], CUBE;
DP4 R3.y, R1, c[12];
ADD R0.xyz, fragment.texcoord[7], c[11].y;
TEX R0, R0, texture[1], CUBE;
DP3 R1.x, fragment.texcoord[7], fragment.texcoord[7];
RSQ R1.x, R1.x;
DP4 R3.x, R0, c[12];
...
dcl_cube s1
dcl_2d s2
def c11, 0.00000000, 1.00000000, 0.00781250, -0.00781250
def c12, 1.00000000, 0.00392157, 0.00001538, 0.00000001
def c13, 0.97000003, 0.25000000, 2.00000000, 128.00000000
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyzw
dcl_texcoord2 v2.xyzw
dcl_texcoord3 v3.xyzw
...
mov_pp r3.w, r0.x
mov_pp r1.x, c7
mad_pp_sat r3.x, r3.w, c8, r1
add r0.xyz, v7, c11.zwww
texld r0, r0, s1
dp4 r2.w, r0, c12
add r0.xyz, v7, c11.wzww
texld r0, r0, s1
dp4 r2.z, r0, c12
add r1.xyz, v7, c11.wwzw
texld r1, r1, s1
dp4 r2.y, r1, c12
add r0.xyz, v7, c11.z
texld r0, r0, s1
...
rcp r0.x, r1.x
mul r0.x, r0, c0.w
mad r0, -r0.x, c13.x, r2
mov r1.x, c3
cmp r1, r0, c11.y, r1.x
dp3_pp r2.x, v4, v4
texld r0, v0, s0
mul_pp r0, r0, c4
add_pp r2.w, -r3.x, c11.y
mul_pp r0.xyz, r0, r2.w
rsq_pp r2.x, r2.x
mul_pp r0.xyz, r0, c1
mul_pp r3.xyz, r2.x, v4
dp3_pp r2.y, v5, v5
rsq_pp r2.x, r2.y
mad_pp r2.xyz, r2.x, v5, r3
dp3_pp r2.x, r2, r2
mov_pp r2.y, c5.x
rsq_pp r2.x, r2.x
mul_pp r2.x, r2, r2.z
mul_pp r3.x, c13.w, r2.y
max_pp r3.y, r2.x, c11.x
pow_pp r2, r3.y, r3.x
mov_pp r2.y, c6.x
mad_pp r2.y, r3.w, c8.x, r2
mul_pp r3.x, r2, r2.y
mov_pp r2.xyz, c1
mul_pp r2.xyz, c2, r2
add_pp r3.y, -r0.w, c11
abs_pp r2.w, r3.z
mul_pp r2.w, r2, r3.y
mul_pp r2.xyz, r2, r3.x
max_pp r2.w, r3.z, r2
mad_pp r2.xyz, r0, r2.w, r2
dp3 r0.x, v6, v6
dp4_pp r0.z, r1, c13.y
add_pp r0.y, r0.w, -c10.x
cmp r1.x, r0.y, c11, c11.y
texld r0.x, r0.x, s2
mul r0.x, r0, r0.z
mul_pp r0.xyz, r0.x, r2
mov_pp r1, -r1.x
mul_pp oC0.xyz, r0, c13.z
texkill r1.xyzw
mov_pp oC0.w, r0
"
}
...
MUL R2.xyz, R0.w, R1;
DP3 R1.w, R2, R0;
ADD R1.xyz, fragment.texcoord[7], c[11].yzzw;
...
RSQ R3.x, R3.x;
MAD R3.xyz, R3.x, fragment.texcoord[5], R2;
MOV R2.x, c[6];
DP3 R2.y, R3, R3;
MAD R2.x, R2.w, c[8], R2;
RSQ R2.w, R2.y;
MOV R2.y, c[13].w;
MUL R2.w, R2, R3.z;
MUL R3.x, R2.y, c[5];
MAX R2.y, R2.w, c[13].z;
POW R2.y, R2.y, R3.x;
MUL R2.y, R2, R2.x;
MOV R3.xyz, c[2];
MUL R3.xyz, R3, c[1];
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = (tmpvar_20 * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz));
  c.w = tmpvar_19;
  c.xyz = (c.xyz + tmpvar_18);
  c.w = tmpvar_19;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = (tmpvar_20 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6).x * 2.0))));
  c.w = tmpvar_19;
  c.xyz = (c.xyz + tmpvar_18);
  c.w = tmpvar_19;
  gl_FragData[0] = c;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 37 to 44, TEX: 2 to 4
//   d3d9 - ALU: 38 to 45, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
dcl_cube s1
dcl_2d s2
def c6, 0.00000000, 1.00000000, 2.00000000, 8.00000000
...
DP3 R1.w, R1, R2;
MUL R3.xyz, R1, R1.w;
MAD R2.xyz, -R3, c[7].y, R2;
DP3 R1.w, R2, R2;
RSQ R1.w, R1.w;
MUL R3.yzw, R1.w, R2.xxyz;
DP3 R1.x, R3.yzww, R1;
SLT R1.w, R0, c[6].x;
ABS R1.x, R1;
ADD R1.y, -R1.x, c[7].x;
...
MOV_SAT R2.x, R2.w;
DP3_SAT R1.w, R1, c[8];
MAD R1.w, -R1, R1, c[7].x;
ADD R2.x, -R2, c[7];
MUL R2.xyz, R0, R2.x;
MAD R3.yzw, R0.xxyz, R1.xxyz, -R1.xxyz;
MUL R1.w, R1, c[5].x;
MAD R1.xyz, R1.w, R3.yzww, R1;
MUL R0.xyz, R2, fragment.texcoord[5];
ADD R1.w, -R0, c[7].x;
ABS R2.w, fragment.texcoord[4].z;
MUL R1.w, R2, R1;
MAX R1.w, fragment.texcoord[4].z, R1;
MUL R2.xyz, R2, c[0];
MUL R1.w, R1, R3.x;
MUL R2.xyz, R1.w, R2;
MAD R0.xyz, R2, c[7].y, R0;
...
mov_pp r3.x, c2
mad_pp r3.x, r4.x, c3, r3
mul_pp r4.xyz, r3.x, r0
dp3_pp_sat r0.x, r4, c8
mad_pp r0.x, -r0, r0, c7.y
mov_pp_sat r3.x, r3
mad_pp r5.xyz, r1, r4, -r4
mul_pp r0.x, r0, c5
...
TEX R0, fragment.texcoord[0], texture[0], 2D;
TXP R3.x, fragment.texcoord[6], texture[2], 2D;
MOV R4.x, fragment.texcoord[1].z;
MOV R4.y, fragment.texcoord[2].z;
MOV R4.z, fragment.texcoord[3];
MOV R2.x, fragment.texcoord[1].w;
MOV R2.z, fragment.texcoord[3].w;
MOV R2.y, fragment.texcoord[2].w;
DP3 R1.x, R4, R2;
...
mov_pp r0.x, c1
mad_pp r0.x, r5.x, c2, r0
mul_pp r5.xyz, r0.x, r1
dp3_pp_sat r1.x, r5, c7
mad_pp r1.x, -r1, r1, c6.y
mov_pp_sat r0.x, r0
mad_pp r6.xyz, r3, r5, -r5
add_pp r0.x, -r0, c6.y
mul_pp r1.x, r1, c4
...
void main ()
{
  ...
  lowp vec3 tmpvar_17;
  tmpvar_17 = (tmpvar_14.xyz * (1.0 - clamp ((_Reflection + tmpvar_15), 0.0, 1.0)));
  float x_i0_i1;
  x_i0_i1 = (tmpvar_16 - _Cutoff);
  if ((x_i0_i1 < 0.0)) {
    disBIKEd;
  };
  ...
  lightDir = tmpvar_18;
  highp vec2 tmpvar_19;
  tmpvar_19 = vec2(dot (xlv_TEXCOORD5, xlv_TEXCOORD5));
  lowp vec4 tmpvar_20;
  ...
  NdotL = tmpvar_22;
  lowp float tmpvar_23;
  tmpvar_23 = max (NdotL, (abs (NdotL) * (1.0 - tmpvar_16)));
  mediump vec3 tmpvar_24;
  tmpvar_24 = ((tmpvar_17 * _LightColor0.xyz) * ((tmpvar_23 * atten) * 2.0));
  c_i0_i1.xyz = tmpvar_24;
  c_i0_i1.w = tmpvar_16;
  tmpvar_21 = c_i0_i1;
  c = tmpvar_21;
...
void main ()
{
  ...
  tmpvar_19 = dot (vec3(0.0, 0.0, 1.0), lightDir_i0);
  NdotL = tmpvar_19;
  lowp float tmpvar_20;
  tmpvar_20 = max (NdotL, (abs (NdotL) * (1.0 - tmpvar_16)));
  mediump vec3 tmpvar_21;
  tmpvar_21 = ((tmpvar_17 * _LightColor0.xyz) * (tmpvar_20 * 2.0));
...
void main ()
{
  ...
  lightDir = tmpvar_18;
  lowp float tmpvar_19;
  tmpvar_19 = texture2D (_LightTexture0, ((xlv_TEXCOORD5.xy / xlv_TEXCOORD5.w) + 0.5)).w;
  lowp float tmpvar_20;
  highp vec3 LightCoord_i0;
  LightCoord_i0 = xlv_TEXCOORD5.xyz;
  highp vec2 tmpvar_21;
  tmpvar_21 = vec2(dot (LightCoord_i0, LightCoord_i0));
  tmpvar_20 = texture2D (_LightTextureB0, tmpvar_21).w;
  mediump vec4 tmpvar_22;
  mediump vec3 lightDir_i0;
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD5.z > 0.0)) * tmpvar_19) * tmpvar_20);
  lowp vec4 c_i0_i1;
  lowp float NdotL;
  mediump float tmpvar_23;
  ...
  NdotL = tmpvar_23;
  lowp float tmpvar_24;
  tmpvar_24 = max (NdotL, (abs (NdotL) * (1.0 - tmpvar_16)));
  mediump vec3 tmpvar_25;
  tmpvar_25 = ((tmpvar_17 * _LightColor0.xyz) * ((tmpvar_24 * atten) * 2.0));
  c_i0_i1.xyz = tmpvar_25;
  c_i0_i1.w = tmpvar_16;
  tmpvar_22 = c_i0_i1;
  c = tmpvar_22;
...
void main ()
{
  ...
  lightDir = xlv_TEXCOORD4;
  lowp vec4 tmpvar_18;
  tmpvar_18 = texture2D (_LightTexture0, xlv_TEXCOORD5);
  ...
  NdotL = tmpvar_20;
  lowp float tmpvar_21;
  tmpvar_21 = max (NdotL, (abs (NdotL) * (1.0 - tmpvar_16)));
  mediump vec3 tmpvar_22;
  tmpvar_22 = ((tmpvar_17 * _LightColor0.xyz) * ((tmpvar_21 * atten) * 2.0));
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 32 to 44, TEX: 1 to 3
//   d3d9 - ALU: 35 to 46, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
POW R0.x, R0.x, c[4].x;
MOV R0.y, c[2].x;
MAD_SAT R0.y, R0.x, c[3].x, R0;
DP3 R0.x, fragment.texcoord[4], fragment.texcoord[4];
RSQ R2.x, R0.x;
ADD R0.y, -R0, c[6].x;
MUL R0.xyz, R1, R0.y;
MUL R1.x, R2, fragment.texcoord[4].z;
ABS R1.y, R1.x;
ADD R1.z, -R1.w, c[6].x;
MUL R1.y, R1, R1.z;
MAX R1.x, R1, R1.y;
...
MAD R0.xy, fragment.texcoord[5], R0.x, c[6].z;
MOV R1.x, fragment.texcoord[1].z;
MOV R1.y, fragment.texcoord[2].z;
MOV R1.z, fragment.texcoord[3];
MOV result.color.w, R2;
...
ABS R1.y, R1.x;
MUL R1.y, R1, R1.z;
SLT R1.z, c[6].y, fragment.texcoord[5];
MUL R0.w, R1.z, R0;
MUL R1.z, R0.w, R1.w;
MAX R0.w, R1.x, R1.y;
MUL R0.xyz, R2, c[0];
