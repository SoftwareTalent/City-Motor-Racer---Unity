...
void main ()
{
  ...
  lowp vec3 tmpvar_22;
  tmpvar_22 = mix (CubeTex, (CubeTex * tmpvar_17.xyz), vec3(((1.0 - (tmpvar_20 * tmpvar_20)) * _Metalics)));
  lowp float tmpvar_23;
  tmpvar_23 = tmpvar_17.w;
  lowp vec3 tmpvar_24;
  tmpvar_24 = (tmpvar_17.xyz * (1.0 - clamp (tmpvar_19, 0.0, 1.0)));
  float x_i0_i1;
  x_i0_i1 = (tmpvar_23 - _Cutoff);
  if ((x_i0_i1 < 0.0)) {
    disBIKEd;
  };
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 44 to 70, TEX: 3 to 5
//   d3d9 - ALU: 47 to 75, TEX: 5 to 7
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
...
MAD R0.w, R1, c[6].x, R0;
MUL R3.xyz, R0.w, R0;
MOV_SAT R2.x, R0.w;
DP3_SAT R2.w, R3, c[11];
TEX R0, fragment.texcoord[0], texture[1], 2D;
MUL R0, R0, c[2];
ADD R2.x, -R2, c[10].y;
MUL R2.xyz, R0, R2.x;
MAD R2.w, -R2, R2, c[10].y;
MOV R3.w, c[4].x;
MAD R0.xyz, R0, R3, -R3;
MUL R2.w, R2, c[8].x;
MAD R4.xyz, R2.w, R0, R3;
MUL R3.xyz, R2, fragment.texcoord[6];
...
mov_pp r1.w, r2.x
mov_pp r0.w, c3.x
add_pp r0.w, c10.y, -r0
mul_pp r0.w, r0, c11.y
mov_pp r2.x, c5
texldl r0.xyz, r0, s2
mad_pp r0.w, r1, c6.x, r2.x
mul_pp r0.xyz, r0.w, r0
dp3_pp_sat r3.x, r0, c12
mad_pp r3.w, -r3.x, r3.x, c10.y
texld r2, v0, s1
mul_pp r2, r2, c2
mov_pp_sat r0.w, r0
...
dp3_pp r0.x, r1, r0
mov_pp r0.w, c3.x
mul_pp r3.w, c11.x, r0
max_pp r4.w, r0.x, c10.x
pow_pp r0, r4.w, r3.w
mov_pp r0.y, c4.x
dp3_pp r0.w, r1, v5
mad_pp r0.y, r1.w, c6.x, r0
...
mov_pp r0.y, r0.x
mov_pp r0.x, c2
mad_pp r2.x, r0.y, c3, r0
mov_pp_sat r0.w, r2.x
mov_pp r0.z, c1.x
add_pp r0.z, c7.y, -r0
mul_pp r1.w, r0.z, c8.x
texldl r0.xyz, r1, s2
...
POW R1.w, R0.x, c[7].x;
MOV R0.y, c[5].x;
MAD R0.w, R1, c[6].x, R0.y;
TEX R0.xyz, R1, texture[2], CUBE;
MUL R1.xyz, R0.w, R0;
MOV_SAT R2.w, R0;
DP3_SAT R3.x, R1, c[11];
MAD R3.w, -R3.x, R3.x, c[10].y;
TEX R0, fragment.texcoord[0], texture[1], 2D;
MUL R0, R0, c[2];
MAD R3.xyz, R0, R1, -R1;
MUL R3.w, R3, c[8].x;
MAD R4.xyz, R3.w, R3, R1;
ADD R2.w, -R2, c[10].y;
MUL R1.xyz, R0, R2.w;
DP3 R2.w, fragment.texcoord[4], fragment.texcoord[4];
MOV R3.w, c[4].x;
MOV R0.xyz, fragment.texcoord[5];
RSQ R2.w, R2.w;
MAD R3.xyz, R2.w, fragment.texcoord[4], R0;
MUL R0.xyz, R1, c[0];
DP3 R2.w, R3, R3;
RSQ R2.w, R2.w;
MUL R3.xyz, R2.w, R3;
...
void main ()
{
  ...
  frez = tmpvar_18;
  lowp float tmpvar_19;
  tmpvar_19 = (_Gloss + tmpvar_18);
  lowp float tmpvar_20;
  tmpvar_20 = tmpvar_17.w;
  lowp vec3 tmpvar_21;
  tmpvar_21 = (tmpvar_17.xyz * (1.0 - clamp ((_Reflection + tmpvar_18), 0.0, 1.0)));
  float x_i0_i1;
  ...
  tmpvar_24 = vec2(dot (xlv_TEXCOORD6, xlv_TEXCOORD6));
  lowp vec3 viewDir;
  viewDir = tmpvar_23;
  lowp float atten;
  atten = texture2D (_LightTexture0, tmpvar_24).w;
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_25;
  tmpvar_25 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_26;
  tmpvar_26 = max (tmpvar_25, (abs (tmpvar_25) * (1.0 - tmpvar_20)));
  lowp float tmpvar_27;
  ...
  nh = tmpvar_28;
  mediump float tmpvar_29;
  tmpvar_29 = (pow (tmpvar_28, (_Shininess * 128.0)) * tmpvar_19);
  mediump vec3 tmpvar_30;
  tmpvar_30 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_26) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_29)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_30;
  mediump float tmpvar_31;
  tmpvar_31 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_29) * atten));
  c_i0_i1.w = tmpvar_31;
  c = c_i0_i1;
  c.w = tmpvar_20;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_23;
  tmpvar_23 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_24;
  tmpvar_24 = max (tmpvar_23, (abs (tmpvar_23) * (1.0 - tmpvar_20)));
  lowp float tmpvar_25;
  tmpvar_25 = dot (tmpvar_11, normalize ((lightDir + viewDir)));
  nh = tmpvar_25;
...
void main ()
{
  ...
  viewDir = tmpvar_23;
  lowp float atten;
  atten = ((float((xlv_TEXCOORD6.z > 0.0)) * texture2D (_LightTexture0, ((xlv_TEXCOORD6.xy / xlv_TEXCOORD6.w) + 0.5)).w) * texture2D (_LightTextureB0, tmpvar_24).w);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_25;
  tmpvar_25 = dot (tmpvar_11, lightDir);
...
void main ()
{
  ...
  viewDir = tmpvar_23;
  lowp float atten;
  atten = (texture2D (_LightTextureB0, tmpvar_24).w * textureCube (_LightTexture0, xlv_TEXCOORD6).w);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_25;
  tmpvar_25 = dot (tmpvar_11, lightDir);
...
void main ()
{
  ...
  tmpvar_27 = (pow (tmpvar_26, (_Shininess * 128.0)) * tmpvar_19);
  mediump vec3 tmpvar_28;
  tmpvar_28 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_24) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_27)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_28;
  mediump float tmpvar_29;
  tmpvar_29 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_27) * atten));
  c_i0_i1.w = tmpvar_29;
  c = c_i0_i1;
  c.w = tmpvar_20;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_23 = normalize (xlv_TEXCOORD5);
  lowp float tmpvar_24;
  tmpvar_24 = texture2D (_LightTexture0, ((xlv_TEXCOORD6.xy / xlv_TEXCOORD6.w) + 0.5)).w;
  lowp float tmpvar_25;
  highp vec3 LightCoord_i0;
  LightCoord_i0 = xlv_TEXCOORD6.xyz;
  ...
  highp float tmpvar_29;
  if ((tmpvar_28.x < (xlv_TEXCOORD7.z / xlv_TEXCOORD7.w))) {
  ...
  viewDir = tmpvar_23;
  lowp float atten;
  atten = (((float((xlv_TEXCOORD6.z > 0.0)) * tmpvar_24) * tmpvar_25) * tmpvar_27);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_30;
  tmpvar_30 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_31;
  tmpvar_31 = max (tmpvar_30, (abs (tmpvar_30) * (1.0 - tmpvar_20)));
  lowp float tmpvar_32;
  tmpvar_32 = dot (tmpvar_11, normalize ((lightDir + viewDir)));
  nh = tmpvar_32;
  mediump float tmpvar_33;
  tmpvar_33 = max (0.0, nh);
  nh = tmpvar_33;
  mediump float tmpvar_34;
  tmpvar_34 = (pow (tmpvar_33, (_Shininess * 128.0)) * tmpvar_19);
  mediump vec3 tmpvar_35;
  tmpvar_35 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_31) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_34)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_35;
  mediump float tmpvar_36;
  tmpvar_36 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_34) * atten));
  c_i0_i1.w = tmpvar_36;
  c = c_i0_i1;
  c.w = tmpvar_20;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_24;
  tmpvar_24 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_25;
  tmpvar_25 = max (tmpvar_24, (abs (tmpvar_24) * (1.0 - tmpvar_20)));
  lowp float tmpvar_26;
  tmpvar_26 = dot (tmpvar_11, normalize ((lightDir + viewDir)));
  nh = tmpvar_26;
  mediump float tmpvar_27;
  ...
  tmpvar_29 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_25) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_28)) * (tmpvar_23 * 2.0));
  c_i0_i1.xyz = tmpvar_29;
  mediump float tmpvar_30;
  tmpvar_30 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_28) * tmpvar_23));
  c_i0_i1.w = tmpvar_30;
  c = c_i0_i1;
  c.w = tmpvar_20;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  highp float tmpvar_27;
  tmpvar_27 = ((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97);
  highp vec4 packDist;
  lowp vec4 tmpvar_28;
  tmpvar_28 = textureCube (_ShadowMapTexture, xlv_TEXCOORD7);
  packDist = tmpvar_28;
  highp float tmpvar_29;
  tmpvar_29 = dot (packDist, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp float tmpvar_30;
  ...
  viewDir = tmpvar_23;
  lowp float atten;
  atten = ((tmpvar_25.w * tmpvar_26.w) * tmpvar_30);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_31;
  tmpvar_31 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_32;
  tmpvar_32 = max (tmpvar_31, (abs (tmpvar_31) * (1.0 - tmpvar_20)));
  lowp float tmpvar_33;
  tmpvar_33 = dot (tmpvar_11, normalize ((lightDir + viewDir)));
  nh = tmpvar_33;
  mediump float tmpvar_34;
  tmpvar_34 = max (0.0, nh);
  nh = tmpvar_34;
  mediump float tmpvar_35;
  tmpvar_35 = (pow (tmpvar_34, (_Shininess * 128.0)) * tmpvar_19);
  mediump vec3 tmpvar_36;
  tmpvar_36 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_32) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_35)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_36;
  mediump float tmpvar_37;
  tmpvar_37 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_35) * atten));
  c_i0_i1.w = tmpvar_37;
  c = c_i0_i1;
  c.w = tmpvar_20;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_29 = tmpvar_28.xy;
  lowp float tmpvar_30;
  tmpvar_30 = texture2D (_ShadowMapTexture, (tmpvar_29 + _ShadowOffsets[0].xy)).x;
  shadowVals.x = tmpvar_30;
  highp vec2 tmpvar_31;
  tmpvar_31 = tmpvar_28.xy;
  lowp float tmpvar_32;
  tmpvar_32 = texture2D (_ShadowMapTexture, (tmpvar_31 + _ShadowOffsets[1].xy)).x;
  shadowVals.y = tmpvar_32;
  highp vec2 tmpvar_33;
  tmpvar_33 = tmpvar_28.xy;
  lowp float tmpvar_34;
  tmpvar_34 = texture2D (_ShadowMapTexture, (tmpvar_33 + _ShadowOffsets[2].xy)).x;
  shadowVals.z = tmpvar_34;
  highp vec2 tmpvar_35;
  tmpvar_35 = tmpvar_28.xy;
  lowp float tmpvar_36;
  tmpvar_36 = texture2D (_ShadowMapTexture, (tmpvar_35 + _ShadowOffsets[3].xy)).x;
  shadowVals.w = tmpvar_36;
  bvec4 tmpvar_37;
  tmpvar_37 = lessThan (shadowVals, tmpvar_28.zzzz);
  highp vec4 tmpvar_38;
  ...
  tmpvar_45 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_46;
  tmpvar_46 = max (tmpvar_45, (abs (tmpvar_45) * (1.0 - tmpvar_20)));
  lowp float tmpvar_47;
  tmpvar_47 = dot (tmpvar_11, normalize ((lightDir + viewDir)));
  nh = tmpvar_47;
  mediump float tmpvar_48;
  tmpvar_48 = max (0.0, nh);
  nh = tmpvar_48;
  mediump float tmpvar_49;
  tmpvar_49 = (pow (tmpvar_48, (_Shininess * 128.0)) * tmpvar_19);
  mediump vec3 tmpvar_50;
  tmpvar_50 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_46) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_49)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_50;
  mediump float tmpvar_51;
  tmpvar_51 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_49) * atten));
  c_i0_i1_i2.w = tmpvar_51;
  c = c_i0_i1_i2;
  c.w = tmpvar_20;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  viewDir = tmpvar_23;
  lowp float atten;
  atten = (tmpvar_25.w * tmpvar_26);
  lowp vec4 c_i0_i1_i2;
  mediump float nh;
  lowp float tmpvar_40;
  tmpvar_40 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_41;
  tmpvar_41 = max (tmpvar_40, (abs (tmpvar_40) * (1.0 - tmpvar_20)));
  lowp float tmpvar_42;
  tmpvar_42 = dot (tmpvar_11, normalize ((lightDir + viewDir)));
  nh = tmpvar_42;
  mediump float tmpvar_43;
  tmpvar_43 = max (0.0, nh);
  nh = tmpvar_43;
  mediump float tmpvar_44;
  tmpvar_44 = (pow (tmpvar_43, (_Shininess * 128.0)) * tmpvar_19);
  mediump vec3 tmpvar_45;
  tmpvar_45 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_41) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_44)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_45;
  mediump float tmpvar_46;
  tmpvar_46 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_44) * atten));
...
void main ()
{
  ...
  highp vec4 packDist;
  lowp vec4 tmpvar_28;
  tmpvar_28 = textureCube (_ShadowMapTexture, vec_i0);
  packDist = tmpvar_28;
  shadowVals.x = dot (packDist, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec3 vec_i0_i1;
  vec_i0_i1 = (xlv_TEXCOORD7 + vec3(-0.0078125, -0.0078125, 0.0078125));
  highp vec4 packDist_i0;
  lowp vec4 tmpvar_29;
  tmpvar_29 = textureCube (_ShadowMapTexture, vec_i0_i1);
  packDist_i0 = tmpvar_29;
  shadowVals.y = dot (packDist_i0, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec3 vec_i0_i1_i2;
  vec_i0_i1_i2 = (xlv_TEXCOORD7 + vec3(-0.0078125, 0.0078125, -0.0078125));
  highp vec4 packDist_i0_i1;
  lowp vec4 tmpvar_30;
  tmpvar_30 = textureCube (_ShadowMapTexture, vec_i0_i1_i2);
  packDist_i0_i1 = tmpvar_30;
  shadowVals.z = dot (packDist_i0_i1, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec3 vec_i0_i1_i2_i3;
  vec_i0_i1_i2_i3 = (xlv_TEXCOORD7 + vec3(0.0078125, -0.0078125, -0.0078125));
  highp vec4 packDist_i0_i1_i2;
  lowp vec4 tmpvar_31;
  tmpvar_31 = textureCube (_ShadowMapTexture, vec_i0_i1_i2_i3);
  packDist_i0_i1_i2 = tmpvar_31;
  shadowVals.w = dot (packDist_i0_i1_i2, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec4 tmpvar_32;
  tmpvar_32 = vec4(((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97));
  bvec4 tmpvar_33;
  tmpvar_33 = lessThan (shadowVals, tmpvar_32);
  ...
  viewDir = tmpvar_23;
  lowp float atten;
  atten = ((tmpvar_25.w * tmpvar_26.w) * tmpvar_27);
  lowp vec4 c_i0_i1_i2;
  mediump float nh;
  lowp float tmpvar_41;
  tmpvar_41 = dot (tmpvar_11, lightDir);
  lowp float tmpvar_42;
  tmpvar_42 = max (tmpvar_41, (abs (tmpvar_41) * (1.0 - tmpvar_20)));
  lowp float tmpvar_43;
  tmpvar_43 = dot (tmpvar_11, normalize ((lightDir + viewDir)));
  nh = tmpvar_43;
  mediump float tmpvar_44;
  tmpvar_44 = max (0.0, nh);
  nh = tmpvar_44;
  mediump float tmpvar_45;
  tmpvar_45 = (pow (tmpvar_44, (_Shininess * 128.0)) * tmpvar_19);
  mediump vec3 tmpvar_46;
  tmpvar_46 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_42) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_45)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_46;
  mediump float tmpvar_47;
  tmpvar_47 = (tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_45) * atten));
  c_i0_i1_i2.w = tmpvar_47;
  c = c_i0_i1_i2;
  c.w = tmpvar_20;
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 15
//   opengl - ALU: 58 to 87, TEX: 2 to 8
//   d3d9 - ALU: 63 to 84, TEX: 3 to 9
SubProgram "opengl " {
Keywords { "POINT" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_SpecColor]
...
RSQ R2.w, R2.w;
MAD R3.xyz, R2.w, fragment.texcoord[5], R1;
DP3 R2.w, R3, R3;
RSQ R3.w, R2.w;
DP3 R2.w, R2, R1;
MUL R1.xyz, R3.w, R3;
...
mov_pp r1.w, r0.x
mov_pp r0.x, c5
mad_pp_sat r0.x, r1.w, c6, r0
dp3_pp r0.y, v4, v4
rsq_pp r0.y, r0.y
mul_pp r2.xyz, r0.y, v4
dp3_pp r0.z, v5, v5
rsq_pp r0.y, r0.z
mad_pp r3.xyz, r0.y, v5, r2
add_pp r3.w, -r0.x, c9.y
dp3_pp r2.w, r3, r3
rsq_pp r2.w, r2.w
...
pow_pp r3, r2.w, r4.x
mov_pp r4.y, c4.x
mad_pp r2.w, r1, c6.x, r4.y
dp3_pp r1.w, r1, r2
mov_pp r1.x, r3
mul_pp r2.z, r1.x, r2.w
mov_pp r1.xyz, c0
mul_pp r1.xyz, c1, r1
...
TEX R0, fragment.texcoord[0], texture[1], 2D;
MUL R0, R0, c[2];
MAD R1.w, R1, c[6].x, R3.x;
ADD R1.x, -R1, c[9].y;
MUL R0.xyz, R0, R1.x;
RSQ R2.w, R2.w;
MOV R1.xyz, fragment.texcoord[4];
MAD R1.xyz, R2.w, fragment.texcoord[5], R1;
DP3 R2.w, R1, R1;
RSQ R2.w, R2.w;
MUL R1.xyz, R2.w, R1;
DP3 R1.x, R2, R1;
...
mul_pp r1.y, r1, r1.z
mul_pp r2.xyz, r2, c0
mul_pp r3.y, c10.x, r0.w
max_pp r3.x, r0, c9
pow_pp r0, r3.x, r3.y
mov_pp r0.y, c4.x
mad_pp r1.w, r1, c6.x, r0.y
mov_pp r0.w, r0.x
mov_pp r0.xyz, c0
mul_pp r0.w, r0, r1
mul_pp r0.xyz, c1, r0
...
MAD R1.xy, fragment.texcoord[6], R1.w, c[9].y;
...
add_pp r0.x, r0.w, -c8
rcp r0.y, v6.w
mad r2.xy, v6, r0.y, c9.z
cmp r2.z, r0.x, c9.x, c9.y
dp3 r0.x, v6, v6
texld r1.w, r2, s2
...
MUL R1.xyz, R1, R2.w;
MAD R0.xyz, R0, R1.w, R1;
TEX R1.w, fragment.texcoord[6], texture[2], 2D;
MUL R0.xyz, R1.w, R0;
MUL result.color.xyz, R0, c[9].x;
SLT R0.x, R0.w, c[8];
MOV result.color.w, R0;
...
DP3 R2.w, fragment.texcoord[5], fragment.texcoord[5];
RSQ R0.w, R2.w;
MAD R3.xyz, R0.w, fragment.texcoord[5], R1;
MOV R0.w, c[5].x;
MAD R0.w, R1, c[7].x, R0;
DP3 R2.w, R3, R3;
DP3 R1.w, R2, R1;
RSQ R2.w, R2.w;
MUL R1.xyz, R2.w, R3;
...
mul_pp r0.xyz, r0, r3.w
mul_pp r0.xyz, r0, c0
max_pp r2.w, r2, c10.x
mul_pp r4.x, c11.z, r3
pow_pp r3, r2.w, r4.x
mov_pp r4.y, c5.x
mad_pp r2.w, r1, c7.x, r4.y
dp3_pp r1.w, r1, r2
mov_pp r1.x, r3
mul_pp r2.z, r1.x, r2.w
mov_pp r1.xyz, c0
...
mul_pp r1.xyz, r1, r2.z
abs_pp r2.x, r1.w
add_pp r2.y, -r0.w, c10
mul_pp r2.x, r2, r2.y
max_pp r2.x, r1.w, r2
mad_pp r1.xyz, r0, r2.x, r1
add_pp r1.w, r0, -c9.x
cmp r2.z, r1.w, c10.x, c10.y
texldp r0.x, v7, s4
rcp r0.y, v7.w
...
TEX R1.w, fragment.texcoord[6], texture[3], 2D;
MUL R0.x, R1.w, R0;
MUL R0.xyz, R0.x, R1;
MUL result.color.xyz, R0, c[9].x;
SLT R0.x, R0.w, c[8];
...
TEMP R3;
TEX R0.yw, fragment.texcoord[0].zwzw, texture[0], 2D;
MAD R2.xy, R0.wyzw, c[11].z, -c[11].y;
MUL R0.x, R2.y, R2.y;
MAD R0.x, -R2, R2, -R0;
ADD R0.x, R0, c[11].y;
RSQ R0.x, R0.x;
...
def c13, 2.00000000, -1.00000000, 128.00000000, 0
dcl_texcoord0 v0
dcl_texcoord1 v1
dcl_texcoord2 v2
dcl_texcoord3 v3
...
dp3 r0.w, r2, r0
mul r3.xyz, r2, r0.w
mad r0.xyz, -r3, c11.w, r0
dp3 r0.w, r0, r0
rsq r0.w, r0.w
mul r0.xyz, r0.w, r0
dp3_pp r0.x, r0, r2
abs_pp r0.x, r0
add_pp r1.w, -r0.x, c11.y
pow_pp r0, r1.w, c9.x
mov_pp r1.w, r0.x
mov_pp r0.x, c7
mad_pp_sat r0.x, r1.w, c8, r0
dp3_pp r0.y, v4, v4
rsq_pp r0.y, r0.y
mul_pp r2.xyz, r0.y, v4
dp3_pp r0.z, v5, v5
...
mul_pp r0.xyz, r0, r3.w
mul_pp r0.xyz, r0, c1
max_pp r2.w, r2, c11.x
mul_pp r4.x, c13.z, r3
pow_pp r3, r2.w, r4.x
mov_pp r4.y, c6.x
mad_pp r2.w, r1, c8.x, r4.y
dp3_pp r1.w, r1, r2
mov_pp r1.x, r3
mul_pp r2.z, r1.x, r2.w
mov_pp r1.xyz, c1
...
ADD R2.x, -R0.w, c[11].y;
MUL R1.w, R1, R2.x;
DP3 R2.x, fragment.texcoord[7], fragment.texcoord[7];
MAX R1.w, R2, R1;
MUL R1.xyz, R1, R2.y;
MUL R0.xyz, R0, c[1];
MAD R0.xyz, R0, R1.w, R1;
...
ADD R0.w, -R0, c[14].z;
MOV R1.x, c[10];
POW R0.w, R0.w, c[12].x;
MAD_SAT R2.x, R0.w, c[11], R1;
TEX R1, fragment.texcoord[0], texture[1], 2D;
MUL R1, R1, c[7];
ADD R2.x, -R2, c[14].z;
MUL R1.xyz, R1, R2.x;
...
RSQ R2.w, R2.w;
MAD R3.xyz, R2.w, fragment.texcoord[5], R2;
DP3 R2.w, R3, R3;
RSQ R2.w, R2.w;
MUL R3.xyz, R2.w, R3;
DP3 R3.x, R0, R3;
...
MOV R2.w, c[15].y;
MUL R3.y, R2.w, c[8].x;
MAX R2.w, R3.x, c[14].x;
POW R2.w, R2.w, R3.y;
MAD R0.w, R0, c[11].x, R3;
MOV R3.xyz, c[1];
RCP R2.x, fragment.texcoord[7].w;
MUL R0.w, R2, R0;
MUL R3.xyz, R3, c[0];
MAD R2.zw, fragment.texcoord[7].xyxy, R2.x, c[5].xyxy;
MUL R3.xyz, R3, R0.w;
ADD R0.z, -R1.w, c[14];
ABS R0.y, R0.x;
MUL R0.y, R0, R0.z;
MAX R0.z, R0.x, R0.y;
MAD R0.xy, fragment.texcoord[7], R2.x, c[6];
TEX R0.x, R0, texture[4], 2D;
MOV R0.w, R0.x;
TEX R0.x, R2.zwzw, texture[4], 2D;
MUL R1.xyz, R1, c[0];
MAD R1.xyz, R1, R0.z, R3;
MAD R2.zw, fragment.texcoord[7].xyxy, R2.x, c[4].xyxy;
MOV R0.z, R0.x;
TEX R0.x, R2.zwzw, texture[4], 2D;
MAD R2.zw, fragment.texcoord[7].xyxy, R2.x, c[3].xyxy;
MOV R0.y, R0.x;
TEX R0.x, R2.zwzw, texture[4], 2D;
MAD R0, -fragment.texcoord[7].z, R2.x, R0;
MOV R2.y, c[14].z;
CMP R0, R0, c[2].x, R2.y;
DP4 R2.y, R0, c[14].w;
DP3 R0.z, fragment.texcoord[6], fragment.texcoord[6];
RCP R2.x, fragment.texcoord[6].w;
MAD R0.xy, fragment.texcoord[6], R2.x, c[14].y;
TEX R0.w, R0, texture[2], 2D;
...
def c15, 2.00000000, -1.00000000, 128.00000000, 0
dcl_texcoord0 v0
dcl_texcoord1 v1
dcl_texcoord2 v2
dcl_texcoord3 v3
...
mov_pp r0.w, c8.x
mul_pp r1.xyz, r1, c0
mul_pp r4.x, c15.z, r0.w
max_pp r3.w, r0.x, c14.x
pow_pp r0, r3.w, r4.x
mov_pp r0.y, c9.x
dp3_pp r0.w, r2, r3
rcp r3.z, v7.w
mad_pp r0.y, r2.w, c11.x, r0
mul_pp r2.w, r0.x, r0.y
mov_pp r0.xyz, c0
mul_pp r0.xyz, c1, r0
mul_pp r2.xyz, r0, r2.w
abs_pp r0.x, r0.w
add_pp r0.y, -r1.w, c14
mul_pp r0.z, r0.x, r0.y
max_pp r2.w, r0, r0.z
mad r0.xy, v7, r3.z, c6
texld r0.x, r0, s4
mad_pp r1.xyz, r1, r2.w, r2
mad r3.xy, v7, r3.z, c5
mov r0.w, r0.x
texld r0.x, r3, s4
mad r3.xy, v7, r3.z, c4
mov r0.z, r0.x
texld r0.x, r3, s4
mad r3.xy, v7, r3.z, c3
mov r0.y, r0.x
texld r0.x, r3, s4
mov r3.x, c2
mad r0, -v7.z, r3.z, r0
...
dcl_texcoord7 v7
texld r0.yw, v0.zwzw, s0
mad_pp r1.xy, r0.wyzw, c15.x, c15.y
mul_pp r0.x, r1.y, r1.y
mad_pp r0.x, -r1, r1, -r0
add_pp r0.x, r0, c14.y
rsq_pp r0.x, r0.x
...
pow_pp r0, r1.w, c12.x
texld r2, v0, s1
mul_pp r2, r2, c7
mov_pp r1.w, r0.x
mov_pp r0.y, c10.x
mad_pp_sat r0.x, r1.w, c11, r0.y
add_pp r3.w, -r0.x, c14.y
...
MOV R1.w, c[13];
MUL R2.y, R1.w, c[5].x;
MAX R1.w, R2.x, c[13].z;
POW R1.w, R1.w, R2.y;
MAD R0.w, R0, c[8].x, R3;
MOV R2.xyz, c[2];
MUL R0.w, R1, R0;
MUL R2.xyz, R2, c[1];
MUL R2.xyz, R2, R0.w;
...
def c12, 1.00000000, 0.00392157, 0.00001538, 0.00000001
def c13, 0.97000003, 0.25000000, 2.00000000, -1.00000000
...
dp3_pp r3.w, r1, r4
mov_pp r0.w, c5.x
mul_pp r3.y, c14.x, r0.w
max_pp r3.x, r0, c11
pow_pp r0, r3.x, r3.y
mov_pp r0.y, c6.x
mad_pp r0.y, r1.w, c8.x, r0
...
dp4 r4.x, r0, c12
mul r0.x, r1, c0.w
add_pp r1.z, -r2.w, c11.y
abs_pp r1.y, r3.w
mov r1.x, c3
mad r0, -r0.x, c13.x, r4
...
texld r0.x, r0.x, s3
mul r0.z, r0.x, r0
add_pp r0.y, r2.w, -c10.x
mul_pp r2.xyz, r2, c1
max_pp r1.x, r3.w, r1.y
mad_pp r1.xyz, r2, r1.x, r3
mul_pp r1.xyz, r0.z, r1
cmp r0.x, r0.y, c11, c11.y
mov_pp r0, -r0.x
mul_pp oC0.xyz, r1, c13.z
texkill r0.xyzw
mov_pp oC0.w, r2
"
}
...
RSQ R0.x, R0.y;
MUL R4.xyz, R0.x, fragment.texcoord[4];
DP3 R0.y, fragment.texcoord[5], fragment.texcoord[5];
MOV R3.x, c[6];
MAD R0.w, R0, c[8].x, R3.x;
RSQ R0.x, R0.y;
MAD R0.xyz, R0.x, fragment.texcoord[5], R4;
DP3 R1.w, R0, R0;
RSQ R1.w, R1.w;
MUL R0.xyz, R1.w, R0;
DP3 R0.x, R1, R0;
...
DP4 R4.x, R0, c[12];
MUL R0.x, R1, c[0].w;
ADD R1.z, -R2.w, c[11].w;
ABS R1.y, R3.w;
MOV R1.x, c[11].w;
MAD R0, -R0.x, c[11].x, R4;
CMP R0, R0, c[3].x, R1.x;
DP4 R0.y, R0, c[13].x;
MUL R1.y, R1, R1.z;
DP3 R0.x, fragment.texcoord[6], fragment.texcoord[6];
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 44 to 52, TEX: 3 to 5
//   d3d9 - ALU: 47 to 55, TEX: 4 to 6
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
texld r0, r0, s0
mov r0.x, r0.w
mad_pp r0.xy, r0, c7.z, c7.w
mul_pp r2.x, r0.y, r0.y
mad_pp r2.x, -r0, r0, -r2
add_pp r2.x, r2, c7.y
rsq_pp r2.x, r2.x
rcp_pp r0.z, r2.x
dp3_pp r2.y, r0, t2
...
mov_pp r3.x, c1
mad_pp r3.x, r4.x, c2, r3
mul_pp r5.xyz, r3.x, r0
mov_pp_sat r0.x, r3
dp3_pp_sat r4.x, r5, c7
mad_pp r3.x, -r4, r4, c6.y
add_pp r0.x, -r0, c6.y
mad_pp r4.xyz, r2, r5, -r5
mul_pp r3.x, r3, c4
...
mov_pp r2.x, c2
mad_pp r5.x, r5.x, c3, r2
mov_pp_sat r2.x, r5
mul_pp r5.xyz, r5.x, r3
add_pp r3.x, -r2, c7.y
dp3_pp_sat r2.x, r5, c8
mad_pp r6.xyz, r1, r5, -r5
...
POW R2.w, R2.w, c[3].x;
MOV result.color.w, R1;
TEX R2.xyz, R3.yzww, texture[2], CUBE;
KIL -R0.x;
...
void main ()
{
  ...
  lowp vec3 tmpvar_20;
  tmpvar_20 = (tmpvar_17.xyz * (1.0 - clamp ((_Reflection + tmpvar_18), 0.0, 1.0)));
  float x_i0_i1;
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 40 to 52, TEX: 2 to 4
//   d3d9 - ALU: 46 to 57, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
ADD R0.x, -R0, c[6].y;
MUL R0.xyz, R1, R0.x;
DP3 R1.x, R3, fragment.texcoord[4];
MUL R2.xyz, R0, c[0];
ADD R1.z, -R1.w, c[6].y;
ABS R1.y, R1.x;
MUL R1.y, R1, R1.z;
